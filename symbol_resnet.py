...
def BasicResNetBlock(data, growth_rate, stride, name, bottle_neck=True, drop_out=0.0, bn_mom=0.9, workspace=512):
    cov1 = mx.sym.Convolution(data=data, kernel=(3, 3), stride=(1, 1), pad=(3, 3),
                              no_bias=True, workspace=workspace, name=name + '_conv1')
    bn1 = mx.sym.BatchNorm(data=cov1, fix_gamma=False, eps=2e-5, momentum=bn_mom, name=name + '_branch2a')
...
def ResNet(units, num_stage, growth_rate, num_class, data_type, reduction=0.5, drop_out=0., bottle_neck=True, bn_mom=0.9, workspace=512):
    ...
    cov0 = mx.sym.Convolution(data=data, kernel=(3, 3), stride=(1, 1), pad=(3, 3),
                              no_bias=True, workspace=workspace, name='conv0')
    bn0 = mx.sym.BatchNorm(data=cov0, fix_gamma=False, eps=2e-5, momentum=bn_mom, name='bn2a_branch2a')
    act0 = mx.sym.Activation(data=bn0, act_type='relu', name='relu0')
    cov1 = mx.sym.Convolution(data=act0, )
