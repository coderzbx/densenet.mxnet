...
if __name__ == "__main__":
    ...
    parser.add_argument('--step', type=str, default='3000,10000,30000', help='step size to change lr')
    ...
    parser.add_argument('--num-examples', type=int, default=16816, help='the number of training examples')
